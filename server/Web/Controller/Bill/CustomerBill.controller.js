...
var FranchiseeCustomerBillModel = require('./../../Models/Bill/CustomerBill.model.js');
...
exports.CustomerBill_Create = function(req, res) {
   ...
   if(!ReceivingData.User_Id || ReceivingData.User_Id === '' ) {
      ...
      FranchiseeCustomerBillModel.FranchiseeCustomer_BillSchema.find({},{Bill_Number_Length: 1},{sort:{Bill_Number_Length: -1}, limit: 1})
         .exec(function(BillErr, BillResult){
             if(BillErr){
                ...
                res.status(400).send({Status: false, Message: "Some error occurred while creating the Bill!."});
                 ...
                 var Bill = new FranchiseeCustomerBillModel.FranchiseeCustomer_BillSchema({
                ...
                Bill.save(function(err, result) {
                   if(err) {
                     ...
                     FranchiseeCustomerBillModel.FranchiseeCustomerBill_ProductSchema.collection.insert(itemArray, function(err_1, result_1){
                        if(err_1) {
                           ...
                           const UpdateAll = (info) => Promise.all([
                              FranchiseeStockModel.FranchiseeStockSchema.update(
                              ...
                              FranchiseeStockModel.FranchiseeStockHistorySchema.create([{
                                 FranchiseeProduct_Stock_Id: info.Product._id,
...
exports.CustomerBill_List = function(req, res){
   ...
   if (!ReceivingData.User_Id || ReceivingData.User_Id === ''  ) {
      ...
      FranchiseeCustomerBillModel.FranchiseeCustomer_BillSchema
