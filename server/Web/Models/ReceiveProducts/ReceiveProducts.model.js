...
var ReceiveProductsSchema = mongoose.Schema({
...
var ReceiveProducts_ProductsSchema = mongoose.Schema({
    DeliverProducts_Id: { type: Schema.Types.ObjectId, ref: 'ReceiveProducts'},
    Hub_Id: { type: Schema.Types.ObjectId, ref: 'Hub' },
    Franchisee_Id: { type: Schema.Types.ObjectId, ref: 'Franchisee'},
    PurchaseRequest_Id: { type: Schema.Types.ObjectId, ref: 'PurchaseRequest' },
...
var VarReceiveProductsSchema = mongoose.model('FranchiseeReceiveProducts', ReceiveProductsSchema, 'FranchiseeReceiveProducts_List');
var VarReceiveProducts_ProductsSchema = mongoose.model('FranchiseeReceiverProducts_Products', ReceiveProducts_ProductsSchema, 'FranchiseeReceiverProducts_Products_List');

module.exports = {
    ReceiveProductsSchema: VarReceiveProductsSchema,
    ReceiveProducts_ProductsSchema: VarReceiveProducts_ProductsSchema
}